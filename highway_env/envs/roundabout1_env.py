...
##########################
    ...
    def _make_road(self) -> None:
        ...
        my_angle_cos1 = math.cos(math.pi/3*-1)
        my_angle_sin1 = math.sin(math.pi/3*-1)
        my_angle_cos2 = math.cos(math.pi/3*-2)
        my_angle_sin2 = math.sin(math.pi/3*-2)
    ...
    def _make_vehicles(self) -> None:
        ...
        pre_rote = [("eer", "ees", 0),("wer", "wes", 0),("ser", "ses", 0)]
